...
var ActionVendor = function () {
    function ActionVendor() {
        classCallCheck(this, ActionVendor);

        this._actionsForKey = {};
    }

    createClass(ActionVendor, [{
        key: 'putActionByKey',
...
function createAction(config, controller) {
    ...
    if (typeof config.controller !== 'function') {
        throw new Error('illegal controller,the type of controller must be function,but got ' + _typeof(config.controller));
    }
...
var RemoteProvider = function (_Provider) {
    inherits(RemoteProvider, _Provider);

    function RemoteProvider(config) {
        classCallCheck(this, RemoteProvider);

        var _this = possibleConstructorReturn(this, (RemoteProvider.__proto__ || Object.getPrototypeOf(RemoteProvider)).call(this, config));
...
var SessionProvider = function (_Provider) {
    inherits(SessionProvider, _Provider);

    function SessionProvider() {
        classCallCheck(this, SessionProvider);
        return possibleConstructorReturn(this, (SessionProvider.__proto__ || Object.getPrototypeOf(SessionProvider)).apply(this, arguments));
    }

    createClass(SessionProvider, [{
        key: 'get',
         ...
         */
        value: function get$$1() {
            var value = get(SessionProvider.prototype.__proto__ || Object.getPrototypeOf(SessionProvider.prototype), 'get', this).call(this);
            this._value = null;
            return value;
        }
    }]);
...
var StorageProvider = function (_Provider) {
    inherits(StorageProvider, _Provider);

    function StorageProvider(config) {
        classCallCheck(this, StorageProvider);
        return possibleConstructorReturn(this, (StorageProvider.__proto__ || Object.getPrototypeOf(StorageProvider)).call(this, config));
    }

    createClass(StorageProvider, [{
        key: 'get',
        value: function get$$1() {
            var _this2 = this;
            ...
            if (!this._synced) {
                return storageTool.getter(this._name).then(function (v) {
                    ...
                    _this2._synced = true;
                    return get(StorageProvider.prototype.__proto__ || Object.getPrototypeOf(StorageProvider.prototype), 'get', _this2).call(_this2);
                });
            } else {
                return get(StorageProvider.prototype.__proto__ || Object.getPrototypeOf(StorageProvider.prototype), 'get', this).call(this);
            }
        }
    }, {
        key: 'set',
        value: function set$$1(v) {
            get(StorageProvider.prototype.__proto__ || Object.getPrototypeOf(StorageProvider.prototype), 'set', this).call(this, v);
        ...
        value: function render() {
            return react.createElement(
                ...
                react.createElement(
                    ...
                    react.createElement(
                        'p',
                        { 'class': 'new-todo-container' },
                        react.createElement('input', { 'class': 'new-todo', placeholder: '\u9700\u8981\u505A\u4EC0\u4E48\uFF1F' })
                    ),
...
reactDom.render(react.createElement(App, null), document.getElementById('react-placeholder'));
